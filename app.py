...
if not DATABASE_URL:
    raise RuntimeError("No se encontró DATABASE_URL. Configura la cadena de conexión de Neon en las variables de entorno.")
...
# Recomendado para conexiones SSL/pooled de Postgres serverless
